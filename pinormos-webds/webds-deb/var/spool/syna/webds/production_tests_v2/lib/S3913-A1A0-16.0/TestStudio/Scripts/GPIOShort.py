## DO NOT MODIFY
## b5ede98d15230142db71977045db46456e4b3e74-1.0.0.7
## DO NOT MODIFY
## Metadata:
# <?xml version="1.0" encoding="utf-8"?>
# <metadata name="GPIO Short Test" description="GPIO Short Test" bin="33" product="S3913">
#       <parameter name="Limits" type="string[][]" description="Limits for GPIO Short Test"
#                   isoptional="false"
#                   islimit = "true"
...
class ReportBasedTest(object):
    def __init__(self):
        ...
        self.NAME = 'GPIO Short Test'
        self.DATA_COLLECTING_TYPE = 'production_test'
    ...
    def get_required_vars(self):
        ...
        try:
            ...
            Comm2Functions.Trace("GPIO Mask found: {0}".format(temp[0]))
