## DO NOT MODIFY
## 6bd459ddaa73e1f6efaa48694a47d0d9c45a984b-1.0.0.8
## DO NOT MODIFY
## Metadata:
# <?xml version="1.0" encoding="utf-8"?>
# <metadata name="Sensor Speed Test" description="Sensor Speed" bin="23" product="S3913">
#       <parameter name="Limits" type="string[][]" description="Limits for Sensor Speed Test"
#                   isoptional="false"
#                   islimit = "true"
...
class ReportBasedTest(object):
    ...
    def data_byte_array_to_matrix(self, byte_array):
        ...
        # Sensor speed test is in fF convert to pF
        pf_array = [float(x) / 1000 for x in converted_array]
