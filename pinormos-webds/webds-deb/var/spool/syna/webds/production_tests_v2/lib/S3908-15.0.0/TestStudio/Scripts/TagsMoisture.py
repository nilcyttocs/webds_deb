## DO NOT MODIFY
## 44ce26c398013ec2492ba367e464b86b5eb8fa88-1.0.0.7
## DO NOT MODIFY
## Metadata:
# <?xml version="1.0" encoding="utf-8"?>
# <metadata name="Tags Moisture" description="Tags Moisture Test" bin="56" product="S3908">
#       <parameter name="Limits" type="string[][]" description="Limits for Tags Moisture Test"
#                   isoptional="false"
#                   islimit = "true"
...
class ReportBasedTest(object):
    ...
    def _get_expected_length(self, **kwargs):
        ...
        if self._has_trans:
            return int(row_count * col_count * (bpp / 8))
        elif self._has_abs:
            return int(col_count * self._bit_per_pixel / 8)
    ...
    def _default_report_data_converter(self, byte_array,
        ...
        if word_size is not 2 and word_size is not 1 and word_size is not 4:
    ...
    def data_byte_array_to_matrix(self, byte_array):
        ...
        for row in range(0, self.num_rows):
            for column in range(0, self.num_cols):
                # convert to pF
                matrix[row][column] = converted_array[i] / float(1000)
                i += 1
        return matrix
